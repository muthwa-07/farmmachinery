...
const navigate = useNavigate()
  ...
  return (
    <div className="row">
      <Navbar/>
      <ImageCarousel/>
      <h3 className="text-info mt-3 title-fade-in">Available machines</h3>
      ...
      {filtered_machines.map((machine)=> (
        ...
        <div className="card shadow">
            ...
            <div className="card-body">
              ...
              <p className='text-muted'>{machine.machine_description.slice(0, 100)}</p>
              <p className='text-muted'>{machine.machine_quality.slice(0, 50)}</p>
